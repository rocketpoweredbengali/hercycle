          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="space-y-4 text-sm p-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent/20 text-accent-foreground">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-emerald-400/20 text-emerald-600">
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
               ...
               <Button className="w-full font-bold transition-transform duration-200 hover:scale-105 hover:shadow-lg relative before:absolute before:inset-0 before:bg-gradient-to-r before:from-accent before:to-orange-400 before:rounded-md before:opacity-0 hover:before:opacity-100 before:transition-opacity">
                 <span className="relative z-10 text-white">Log Symptoms</span>
               </Button>
            </CardContent>
          </Card>
        </div>
